                ...
                <form action="{{ route('storeSoal') }}" method="post" enctype="multipart/form-data">@csrf
                    <div class="col-md-12">
                        <div class="dor">
                            ...
                            <textarea id="js-summernote" class="js-summernote text-danger" name="pertanyaan_name">Jika anda mengunggah gambar Pastikan Gambar anda memiliki kualitas yang baik. Apabila gambar anda terlalu besar untuk dapat di tampilkan maka resize gambar anda ke 75% atau 50%.
