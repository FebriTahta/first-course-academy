                ...
                <div class="item">
                    <div class="row slider-info">
                        ...
                        <div class="col-lg-4 col-md-8 img-circle mt-lg-0 mt-4">
                            <img src="{{ ('assets/assets/images/beauty.jpg') }}" class="img-fluid radius-image-full" alt="client image">
                        </div>
                    </div>
                </div>
                <div class="item">
                    <div class="row slider-info">
                        ...
                        <div class="col-lg-4 col-md-8 img-circle mt-lg-0 mt-4">
                            <img src="{{ ('assets/assets/images/fashion.jpg') }}" class="img-fluid radius-image-full" alt="client image">
                        </div>
                    </div>
                </div>
                <div class="item">
                    <div class="row slider-info">
                        ...
                        <div class="col-lg-4 col-md-8 img-circle mt-lg-0 mt-4">
                            <img src="{{ ('assets/assets/images/food.jpg') }}" class="img-fluid radius-image-full" alt="client image">
                        </div>
                    </div>
                </div>
                <div class="item">
                    <div class="row slider-info">
                        ...
                        <div class="col-lg-4 col-md-8 img-circle mt-lg-0 mt-4">
                            <img src="{{ ('assets/assets/images/lifestyle.jpg') }}" class="img-fluid radius-image-full"
                                alt="client image">
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
                        ...
                        <div class="card">
                            <div class="card-header p-0 position-relative">
                                <a href="#blog-single.html">
                                    <img class="card-img-bottom d-block radius-image-full"
                                        src="{{ ('assets/assets/images/image1.jpg') }}" alt="Card image cap">
                                </a>
                            </div>
                            <div class="card-body blog-details">
                                ...
                                <div class="author align-items-center mt-3 mb-1">
                                    <img src="{{ ('assets/assets/images/a1.jpg') }}" alt="" class="img-fluid rounded-circle" />
                                    <ul class="blog-meta">
                                        <li>
                    ...
                    <div class="col-lg-6 col-md-6 mt-md-0 mt-sm-5 mt-4">
                        <div class="card">
                            <div class="card-header p-0 position-relative">
                                <a href="#blog-single.html">
                                    <img class="card-img-bottom d-block radius-image-full"
                                        src="{{ ('assets/assets/images/image2.jpg') }}" alt="Card image cap">
                                </a>
                            </div>
                            <div class="card-body blog-details">
                                ...
                                <p>Lorem ipsum dolor sit amet consectetur ipsum adipisicing elit. Quis
                                    vitae sit.</p>
                                <div class="author align-items-center mt-3 mb-1">
                                    <img src="{{ ('assets/assets/images/a2.jpg') }}" alt="" class="img-fluid rounded-circle" />
                                    <ul class="blog-meta">
                                        <li>
            ...
            <div class="col-lg-4 trending mt-lg-0 mt-5">
                ...
                <div class="sponsers mt-5">
                    ...
                    <a href="#ad-banner"><img src="{{ ('assets/assets/images/ad.jpg') }}" alt="" class="img-fluid radius-image-full" /></a>
            ...
            <div class="col-lg-4 col-md-6 mt-lg-0 mt-4">
                <div class="top-pic3">
                    <div class="card-body blog-details">
                        ...
                        <div class="author align-items-center">
                            <img src="{{ ('assets/assets/images/a3.jpg') }}" alt="" class="img-fluid rounded-circle" />
                            <ul class="blog-meta">
                                <li>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 item">
                <div class="card">
                    <div class="card-header p-0 position-relative">
                        <a href="#blog-single.html">
                            <img class="card-img-bottom d-block radius-image-full" src="{{ ('assets/assets/images/fashion1.jpg') }}"
                                alt="Card image cap">
                        </a>
                    </div>
                    <div class="card-body blog-details">
            ...
            <div class="col-lg-4 col-md-6 mt-md-0 mt-4">
                <div class="card">
                    <div class="card-header p-0 position-relative">
                        <a href="#blog-single.html">
                            <img class="card-img-bottom d-block radius-image-full" src="{{ ('assets/assets/images/fashion2.jpg') }}"
                                alt="Card image cap">
                        </a>
                    </div>
                    <div class="card-body blog-details">
                    ...
                    <div class="row">
                        <div class="col-sm-5 position-relative">
                            <a href="#blog-single.html" class="image-mobile">
                                <img class="card-img-bottom d-block radius-image-full" src="{{ ('assets/assets/images/beauty1.jpg') }}"
                                    alt="Card image cap">
                            </a>
                        </div>
            ...
            <div class="col-lg-6 mt-lg-0 mt-4">
                <div class="bg-clr-white hover-box">
                    <div class="row">
                        <div class="col-sm-5 position-relative">
                            <a href="#blog-single.html" class="image-mobile">
                                <img class="card-img-bottom d-block radius-image-full" src="{{('assets/assets/images/beauty2.jpg')}}"
                                    alt="Card image cap">
                            </a>
                        </div>
                        <div class="col-sm-7 card-body blog-details align-self">
            ...
            <div class="col-lg-6 mt-4">
                <div class="bg-clr-white hover-box">
                    <div class="row">
                        <div class="col-sm-5 position-relative">
                            <a href="#blog-single.html" class="image-mobile">
                                <img class="card-img-bottom d-block radius-image-full" src="{{ ('assets/assets/images/beauty3.jpg') }}"
                                    alt="Card image cap">
                            </a>
                        </div>
                        <div class="col-sm-7 card-body blog-details align-self">
            ...
            <div class="col-lg-6 mt-4">
                <div class="bg-clr-white hover-box">
                    <div class="row">
                        <div class="col-sm-5 position-relative">
                            <a href="#blog-single.html" class="image-mobile">
                                <img class="card-img-bottom d-block radius-image-full" src="{{ ('assets/assets/images/beauty4.jpg') }}"
                                    alt="Card image cap">
                            </a>
                        </div>
                        <div class="col-sm-7 card-body blog-details align-self">
                ...
                <div class="bg-clr-white hover-box">
                    <div class="row">
                        <div class="col-sm-6 position-relative">
                            <a href="#blog-single.html">
                                <img class="card-img-bottom d-block radius-image-full" src="{{ ('assets/assets/images/trending1.jpg') }}"
                                    alt="Card image cap">
                            </a>
                        </div>
            ...
            <div class="col-lg-6 mt-lg-0 mt-4">
                <div class="bg-clr-white hover-box">
                    <div class="row">
                        <div class="col-sm-6 position-relative">
                            <a href="#blog-single.html">
                                <img class="card-img-bottom d-block radius-image-full" src="{{ ('assets/assets/images/trending2.jpg') }}"
                                    alt="Card image cap">
                            </a>
                        </div>
                        <div class="col-sm-6 card-body blog-details align-self">
...
<!-- theme changer js -->
<script src="{{ ('assets/assets/js/theme-change.js') }}"></script>
<!-- //theme changer js -->
